...
const SEARCH_INDEX = [
  ...
  { label:'Chat with Admin',  sub:'Get help or custom booking',   emoji:'💬', path:'/(court)/chat'        },
...
export default function CourtDashboardScreen() {
  ...
  const openMaps = () => {
    // ✅ CONFIG is a named export from '@/constants/config' — no change needed here
    ...
    <View style={s.container}>
      ...
      <View style={s.searchWrap}>
        <View style={[s.searchBar, focused && s.searchBarFocused]}>
          ...
          <TextInput
            style={s.searchInput}
            placeholder="Search courts, events, packages..."
      ...
      <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.header}>
          <View>
            ...
            <Text style={s.sub}>Sports Complex · Minglanila, Cebu</Text>
          </View>
